...
export const PRIZE_DISTRIBUTOR_ADDRESS: Record<number, `0x${string}`> = {
  ...
  // Arbitrum Sepolia
  421614: '0xeC0875Ed411Fce21a5B2205a5114feA468b6dF4B',
  // Base Sepolia
  84532: '0xf158BFBe755b2c2a4b4cB16f568a93298e16AE24',
  // Optimism Sepolia
  11155420: '0x77Ee7016BB2A3D4470a063DD60746334c6aD84A4',
};
...
export const NFT_CERTIFICATE_ADDRESS: Record<number, `0x${string}`> = {
  ...
  // Arbitrum Sepolia
  421614: '0x0D52B60838DDE96984563a1Da84E67a8aaA65DC8',
  // Base Sepolia
  84532: '0xA29b25d84F16a168528eD369032EF3a1351a44EF',
  // Optimism Sepolia
  11155420: '0x51FBdDcD12704e4FCc28880E22b582362811cCdf',
};
